...
import abstractFactory.daoFactory.DaoFactory;
import abstractFactory.daoFactory.MySqlDaoFactory;
import abstractFactory.daoFactory.OracleDaoFactory;
...
public class UserInfoClient {
    public static void main(String[] args) throws IOException {
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "/src/abstractFactory/db.properties");
